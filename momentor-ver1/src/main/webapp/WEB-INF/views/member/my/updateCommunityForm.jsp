...
<form class="form-horizontal" action="my_postingCommunity.do"   method="post" id="updateForm">
   <div class="form-group">
      <label for="boardTitle" class="col-sm-2 control-label">제목 : </label>
      <div class="col-sm-10">
         <input type="text" class="form-control" name="boardTitle"
            value="${requestScope.cbvo.boardTitle }" placeholder="제목">
      </div>
   </div>
   <div class="form-group">
   ...
   <div class="form-group">
      ...
      <div class="col-sm-10">
         <textarea rows="7" cols="30" class="form-control" name="boardContent">${requestScope.cbvo.boardContent}</textarea>
      </div>
   </div>
